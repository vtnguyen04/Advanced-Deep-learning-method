...
def get_mae(num_classes, pretrained=False):
    if pretrained:
        # Tải mô hình MAE pretrained từ timm
        model = timm.create_model('mae_vit_base_patch16', pretrained=True)
        
        # Thay thế lớp phân loại cuối cùng
        # Lưu ý: MAE không có lớp head mặc định cho phân loại, nên ta cần thêm vào
        num_features = model.patch_embed.proj.out_channels
        ...
        return mae_vit_base_patch16_dec512d8b(**kwargs)
